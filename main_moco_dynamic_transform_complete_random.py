...
import moco.loader
import moco.builder
from moco.dynamic_transform_dataset_completely_random import ImageFolder
...
parser.add_argument('--mask-file', type=str, help='where to save mask file')
parser.add_argument('--bg-prob', default=0.5, type=float,
                    help='probability to change background')
