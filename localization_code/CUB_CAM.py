...
if flag:
    old_dict = torch.load('/opt/caoyh/code/SSL/CAM/best_finetune_cub_model_stateresnet50.pth.tar')
    new_dict = {}
...
for k, cls in enumerate(classes):
    ...
    for (i, name) in enumerate(files):
        ...
        CAMs = returnCAM(features_blobs[0], weight_softmax, [k])
        ...
        if i<5:
            savepath = 'CUB/Visualization/CAM/{}/{}'.format(model_name, prefix)
